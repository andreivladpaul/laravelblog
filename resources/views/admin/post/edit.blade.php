            ...
            <form role="form"  method="POST" action="{{ route('post.update', $post->id) }}">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="subtitle" value="{{ $post->subtitle }}" class="form-control" id="subtitle" placeholder="Enter subtitle">
                  </div>
                  {{-- slug --}}
                  <div class="form-group">
                    <label for="slug">Post slug</label>
                    <input type="text" name="slug" value="{{ $post->slug }}" class="form-control" id="slug" placeholder="Enter slug">
                  </div>
                  {{-- img --}}
                  <div class="form-group">
                  ...
                  <div class="form-check">
                    <input type="checkbox" name="status" @if ($post->status == 1) checked  @endif class="form-check-input" id="status">
